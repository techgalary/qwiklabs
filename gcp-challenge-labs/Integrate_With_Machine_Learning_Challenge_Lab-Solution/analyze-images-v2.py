...
for file in files:   
   if file.name.endswith('jpg') or  file.name.endswith('png'):
       ...
       # if the locale is Japanese(ja) save the description as the translated_txt
       if locale == 'ja':
           translated_text = desc
       else:
           # TBD: For non ja locales pass the description data to the translation API
           # ref: https://googleapis.dev/python/translation/latest/client.html#google.cloud.translate_v2.client.Client.translate
           # Set the target_language locale to 'ja')
